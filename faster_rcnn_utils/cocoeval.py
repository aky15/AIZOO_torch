...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[4] = _summarize(1, maxDets=self.params.maxDets[0])
            stats[5] = _summarize(1, maxDets=self.params.maxDets[1])
            stats[6] = _summarize(1, maxDets=self.params.maxDets[2])
